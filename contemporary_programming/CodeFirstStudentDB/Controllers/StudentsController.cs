...
namespace CodeFirstStudentDB.Controllers
{
    public class StudentsController : Controller
    {
        private readonly CodeFirstStudentDBContext _context;

        public StudentsController(CodeFirstStudentDBContext context)
        {
            _context = context;
        }
